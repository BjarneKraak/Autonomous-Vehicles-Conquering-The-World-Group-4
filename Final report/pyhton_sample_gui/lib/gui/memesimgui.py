...
class MemeSimGUI():
    ...
    def __init__(self, master):
        ...
        self._memebtn = tk.Button(self._frame, text="Click me", command= self._clicked)
        self._memebtn.pack(fill=tk.X, padx=(10,750), pady=10)
        ...
        self._closebtn.pack(fill=tk.X, padx=(10,750), pady=10)
