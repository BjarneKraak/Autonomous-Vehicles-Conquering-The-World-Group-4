...
void setup() {
  ...
  move.driveInf('f', 5); //drive infinitly forward on half speed, until other functions are called
  delay(3000);// delay for 3s
  move.stopDriving(); // stop driving
  move.turnInf('l', 3); //turn infinitly to the left on 3/10 speed, until other functions are called
